...
namespace NotificationListenerActionCenterApp
{
    ...
    sealed partial class App : Application
    {
        ...
        private async void App_UnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            try
            {
                await new MessageDialog(e.Exception.ToString(), "UnhandledException").ShowAsync();
            }
        ...
        {
            // Make sure notifications are updated after returning from suspend
        ...
        {
            BackgroundTaskHelper.HandleBackgroundTaskActivated(args);
        }
    }
}
